  ...
  <tr>
   ...
   <tr>
    ...
    <td style=""padding:9px 10px 5px 0px;margin:0px;"">" + acc.type_Account + @"</td>
                ...
                mailMessage.From = new MailAddress("wasanyanut.a57@rsu.ac.th");
                mailMessage.To.Add(new MailAddress("wasanyanut.a57@rsu.ac.th"));
                mailMessage.To.Add(new MailAddress("wasanyanut@hotmail.com"));
                mailMessage.CC.Add(new MailAddress("razer1799@gmail.com"));
                ...
                {
                    UserName = "wasanyanut.a57@rsu.ac.th",
                    Password = "password"
                };
